-- CreateEnum
CREATE TYPE "InvoiceStatus" AS ENUM ('DRAFT', 'SENT', 'VIEWED', 'PENDING', 'PARTIALLY_PAID', 'PAID', 'OVERDUE', 'CANCELLED');
...
CREATE TABLE "Business" (
    ...
    "website" TEXT,
    "upiId" TEXT,
    "invoicePrefix" TEXT NOT NULL DEFAULT 'FOL',
    "defaultDuePeriodDays" INTEGER NOT NULL DEFAULT 7,
    "defaultTaxRateBps" INTEGER,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "InvoiceItem" (
    ...
    "lineTotalPaise" INTEGER NOT NULL DEFAULT 0,
